...
version: "1.1-three-layer-governance"
...
editorial_treatment:
  ...
  - "Replaced the earlier four-layer description with the canonical three-layer governance model."
  - "Added explicit routing to the scope gate, inclusive-outcome dataset and evidence-and-conformity record model."
ai_ingestion_guidance:
  - "Retrieve the EAA Scope and Applicability Gate before applying this guide to a product, service, channel or claim."
  - "Use the Inclusive Digital Service Outcome Dataset for functional and experiential outcomes; do not present all of those outcomes as direct statutory duties."
  - "Use the EAA Evidence and Conformity Record Model for requirement conclusions, legal limitations and public claims."
...
## How this guide fits the canonical three-layer model

This guide explains the reasoning and context. It is not the operational record used to decide scope or approve a claim. Use the three canonical layers in this order:

1. [EAA Scope and Applicability Gate](EAA_Scope_and_Applicability_Gate.md) — determine the product or service, economic-operator role, jurisdiction, applicable law, dates, Annex I route and any separately recorded legal limitations.
2. [Inclusive Digital Service Outcome Dataset](https://github.com/Double-FW/Inclusive_and_Effective_Design/blob/main/Inclusive_Digital_Service_Outcome_Dataset.md) — define and evaluate functional, task, equitable and experiential outcomes without presenting them automatically as EAA duties.
3. [EAA Evidence and Conformity Record Model](EAA_Evidence_and_Conformity_Record_Model.md) — connect requirements, standards, tests and outcome evidence to controlled requirement conclusions, claims and monitoring.

The [Accessibility Test-Led Delivery Framework](https://github.com/Double-FW/QA_Accessibility_Testing/blob/main/Accessibility_Test_Led_Delivery_Framework.md) provides the generic requirements, testing, execution, issue, exception, baseline-departure and release records used across the layers.
...
## The practical three-layer model

The earlier four-layer description separated standards and implementation from governance evidence. That created unnecessary overlap and did not make the legal decision route sufficiently clear. The canonical model now uses three layers.

### Layer 1: Scope and applicability

Identify the covered product or service, economic operator, national law, dates, applicable Annex I sections and separately recorded legal limitations. Scope and a limitation are not mutually exclusive: an in-scope service may have a limitation affecting only a defined part of its obligations or operating context.

### Layer 2: Inclusive service outcomes

Define the functional, task, equitable and experiential outcomes relevant to the service. These include technical access, successful completion, reasonable effort, error recovery, autonomy, privacy, dignity, equivalence, confidence, satisfaction and relevant enjoyment. They guide design and evidence collection but are not all direct statutory requirements.

### Layer 3: Evidence and conformity decisions

Map each applicable legal requirement to standards, technical specifications, WCAG criteria, design and implementation records, tests and relevant Layer 2 evidence. Maintain separate results for standards, user outcomes and legal requirements. Record limitations, exceptions, alternative solutions, conclusions, public claims, monitoring and corrective action through named human authorities.
...
This evidence should use the stable identifiers and status vocabularies defined by the three canonical layers and the Accessibility Test-Led Delivery Framework. An outcome finding must not be converted automatically into a legal-requirement conclusion.

The evidence should be maintained as the service changes. A report assembled once and then abandoned does not demonstrate continuous conformity.
...
Complete and approve the EAA Scope and Applicability Gate. Record scope separately from any exemption, transition, fundamental-alteration decision, disproportionate-burden decision or other legal limitation.

### 2. Build a requirements map

Create clause-level requirement records and map the applicable national law and Annex I clauses to standards, design requirements, tests, evidence and accountable owners.
...
Use the Inclusive Digital Service Outcome Dataset to plan proportionate research into functional and experiential outcomes. Ensure recruitment, consent, research tools and participation are accessible. Preserve negative and minority findings rather than relying on an average alone.
...
### 8. Control conclusions and claims

Use the EAA Evidence and Conformity Record Model to reach requirement-level conclusions and approve any public claim. A claim must not exceed its product or service scope, release, jurisdictions, evidence period or recorded limitations.
...
- the approved EAA Scope and Applicability Gate record;
- the Inclusive Digital Service Outcome Dataset and relevant outcome findings;
- the EAA Evidence and Conformity Record Model and relevant requirement conclusions;
- the current Accessibility Test-Led Delivery Framework;
